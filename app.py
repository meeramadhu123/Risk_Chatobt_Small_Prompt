...
# -- Risk/Audit Module --
    ...
    llm_audit = ChatNVIDIA(model="ibnzterrell/Meta-Llama-3.3-70B-Instruct-AWQ-INT4",base_url="http://54.161.46.7:8000/v1/",temperature=0,max_tokens=1024, top_p=0.1,seed=42)
